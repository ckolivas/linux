...
#ifdef CONFIG_64BIT
	/*
	 * Snapshot of cumulative CPU time for lock-wait tracing. Keep this a
	 * plain field read (no rq lock) to match the original CFS path.
	 */
# ifdef CONFIG_SCHED_MUQSS
	ts->running_time = current->sched_time;
# else
